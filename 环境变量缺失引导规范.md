...
> 参考实现：[script-qbase/env_variables/env_check.sh](https://github.com/dvlproad/script-qbase/blob/main/env_variables/env_check.sh)
...
- 0.0.5 (2026-06-06): 新增参考实现引用（script-qbase/env_variables/env_check.sh）
