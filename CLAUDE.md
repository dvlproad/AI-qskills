...
我想给项目加一个 xx 功能，在动手之前，先帮我把这件事拆成一个 to-do 清单。

每一步要满足三个条件：

1. 足够小，你能在一轮对话里完成
2. 有明确的完成标志（比如"文件已创建"或"测试通过"）
3. 下一步依赖上一步的产出

先列清单给我看，我确认后你再开始做第一步。

检验的步骤不同项目内容不一样，但是可以参考这个底层逻辑: 1. 要有能跑的测试2. 能量化的基准 3.能复现的问题4.一定要跑一次端到端流程
